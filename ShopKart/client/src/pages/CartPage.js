              ...
              <div className="mt-4">
                ...
                >
                  {loading ? "Processing ...." : "Make Payment"}
                    ...
                    {
                      loading ? "Processing...." : <StripeCheckout
                        // name="PrimePicks"
                        description={`Your total is ${totalPrice()}`}
                        amount={totalAmountToPay * 100}
                        stripeKey="pk_test_51O6enKK5t3XkyYk5nvhGfkcOL9F5fTHXdOczfSyPZVwu4lfWFmYWJZm8kwFRXjv6y1NpJX8MZ9dQlZudjF2PQHlM00JwjWJWDU"
                        token={onToken}
                        currency="eur"
                      >
                      </StripeCheckout>
